...
let
  ...
  #
  # nix run nixpkgs#nix-prefetch -- fetchzip --url "https://registry.npmjs.org/@anthropic-ai/claude-code/-/claude-code-2.0.33.tgz"
  #
  # npm hash only changes when the dependency updates, and only found after built.
  claude-code-version = "2.0.33";
  claude-code-src-hash = "sha256-Ng9uJj4STRCKk2ndk7zH3fF/OLZ/cvZSGKH2QRyOFcM=";
