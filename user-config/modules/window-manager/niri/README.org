...
Use Noctalia shell for most of the setup. Noctalia is made available via home-manager, launched with systemd.
The below is when I had it launched while testing.
#+begin_src kdl :tangle no
